...
// Dynamic import for the Kerala Court image due to special characters in filename
const KeralaCourtImg = () => {
  try {
    // eslint-disable-next-line import/no-webpack-loader-syntax
    return require("../../assets/img/resource/What-the-Kerala-High-Court's-Mutation.webp");
  } catch (e) {
    // Fallback to another image if the special character file fails
    return require("../../assets/img/resource/Understanding-Legal-Heirship-Certificate.webp");
  }
};
...
const KeralaCourtMutation = () => {
  ...
  const keralaCourtImage = KeralaCourtImg();
